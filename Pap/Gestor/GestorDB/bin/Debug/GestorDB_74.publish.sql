...
GO
ALTER TABLE [dbo].[tblPrhPrincipal]
    ADD [codigo_prhprincipal] CHAR (45) NULL,
        [id_prh]              INT       NULL;
...
Begin
	...
	Begin
		Insert INTO [dbo].[tblPrhPrincipal]
				...
				[outra_modalidade],
				[codigo_prhprincipal])
		Values (@ano_letivo,@turma,@numero_aluno,@nome_aluno,@curso,@disciplina,@tempo_letivos_faltas,@modalidade_adotada,@outra_modalidade,@codigo_prhprincipal)
		select 1 as ReturnCode1
	END
END
GO
...
begin
	...
	Begin
		...
		set id_principal=@id_principal , ano_letivo=@ano_letivo, turma=@turma, numero_aluno=@numero_aluno, nome_aluno=@nome_aluno , curso=@curso ,disciplina=@disciplina ,tempo_letivos_faltas=@tempo_letivos_faltas , modalidade_adotada=@modalidade_adotada , outra_modalidade=@outra_modalidade ,codigo_prhprincipal=@codigo_prhprincipal ,id_prh=@id_prh
		where id_prh=@id_prh
