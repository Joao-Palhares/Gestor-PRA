...
GO
PRINT N'Dropping unnamed constraint on [dbo].[tblTurmaDT]...';


GO
ALTER TABLE [dbo].[tblTurmaDT] DROP CONSTRAINT [UQ__tblTurma__C68D8BC5ABB6378D];
...
GO
ALTER TABLE [dbo].[tblTurmaDT] DROP CONSTRAINT [UQ__tblTurma__BB758482606675C9];
