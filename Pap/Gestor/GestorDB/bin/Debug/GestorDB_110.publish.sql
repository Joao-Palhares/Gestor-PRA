...
AS
begin
		select tblDisciplinas.id_curso, tblDisciplinas.id_disciplina,tblDisciplinas.nome From tblDisciplinas ,tblProfessorTurmaDisciplina where tblProfessorTurmaDisciplina.id_professor=@id_professor
END
GO
