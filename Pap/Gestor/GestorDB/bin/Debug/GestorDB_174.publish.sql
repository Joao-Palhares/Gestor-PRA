...
GO
PRINT N'Altering [dbo].[sp_GetTurmaByDiretorturma]...';


GO
ALTER PROCEDURE [dbo].[sp_GetTurmaByDiretorturma]
@diretor_turma varchar(100)

AS
begin
		select * From tblTurmas where diretor_turma=@diretor_turma
END
GO
