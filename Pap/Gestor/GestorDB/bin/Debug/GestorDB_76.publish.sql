...
begin
	...
	Begin
		...
		set ano_letivo=@ano_letivo, turma=@turma, numero_aluno=@numero_aluno, nome_aluno=@nome_aluno , curso=@curso ,disciplina=@disciplina ,tempo_letivos_faltas=@tempo_letivos_faltas , modalidade_adotada=@modalidade_adotada , outra_modalidade=@outra_modalidade ,codigo_prhprincipal=@codigo_prhprincipal, id_prh=@id_prh
		where id_principal=@id_principal
