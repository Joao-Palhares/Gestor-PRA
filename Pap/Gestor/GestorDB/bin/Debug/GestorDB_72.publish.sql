...
GO
PRINT N'Altering [dbo].[sp_GetDMByCode]...';


GO
ALTER PROCEDURE [dbo].[sp_GetDMByCode]
	@dmcode varchar(50)
AS
begin
...
END
GO
PRINT N'Altering [dbo].[sp_GetDMByCode2]...';


GO
ALTER PROCEDURE [dbo].[sp_GetDMByCode2]
	@dmcode varchar(50)
AS
begin
		select * From tblPraDM where dmcode=@dmcode
END
GO
PRINT N'Altering [dbo].[sp_GetDMByCode3]...';


GO
ALTER PROCEDURE [dbo].[sp_GetDMByCode3]
	@dmcode varchar(50)
AS
begin
		select * From tblPraDM where dmcode=@dmcode
END
GO
PRINT N'Altering [dbo].[sp_GetDMByCode4]...';


GO
ALTER PROCEDURE [dbo].[sp_GetDMByCode4]
	@dmcode varchar(50)
AS
begin
		select * From tblPraDM where dmcode=@dmcode
END
GO
PRINT N'Altering [dbo].[sp_GetDMByCode5]...';


GO
ALTER PROCEDURE [dbo].[sp_GetDMByCode5]
	@dmcode varchar(50)
AS
begin
		select * From tblPraDM where dmcode=@dmcode
