...
GO
PRINT N'Creating [dbo].[sp_GetDisciplinaByProfessor]...';
...
AS
begin
		select * From tblProfessorTurmaDisciplina where id_professor=@id_professor
END
GO
PRINT N'Creating [dbo].[sp_GetProfessorByTurma]...';
...
AS
begin
		select * From tblProfessorTurmaDisciplina where id_turma=@id_turma
END
GO
