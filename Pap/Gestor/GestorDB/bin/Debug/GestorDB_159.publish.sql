...
GO
PRINT N'Creating [dbo].[sp_GetDisciplinaByTurma]...';
...
AS
begin
		Select DISTINCT tblProfessorTurmaDisciplina.id_disciplina, tblDisciplinas.id_disciplina from tblDisciplinas INNER JOIN tblProfessorTurmaDisciplina ON tblProfessorTurmaDisciplina.id_disciplina=tblDisciplinas.id_disciplina where tblProfessorTurmaDisciplina.id_turma=@id_turma
END
GO
