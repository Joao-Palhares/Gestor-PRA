...
END
GO
PRINT N'Creating [dbo].[sp_UpdatePrhDTAvaliacaoByID]...';
...
begin
	...
	Begin
		update tblAvaliacao
		set avaliaçao_atividade=@avaliaçao_atividade,faltas_desconsideradas=@faltas_desconsideradas,data_assinatura_dt=@data_assinatura_dt,codigo_avaliacao=@codigo_avaliacao,id_prh=@id_prh
		where id_avaliaçoes=@id_avaliaçoes
		select 1 as ReturnCode10
	END
END
GO
PRINT N'Creating [dbo].[sp_UpdatePrhProfessorAvaliacaoByID]...';
