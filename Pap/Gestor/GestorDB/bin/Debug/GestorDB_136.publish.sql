...
GO
PRINT N'Creating [dbo].[sp_GetPrhsByAluno]...';
...
AS
BEGIN
	SELECT tblPrh.id_prh ,tblAlunos.id_aluno,tblAlunos.nome,tblTurmas.id_turma ,tblTurmas.nome_turma,tblProfessores.id_professor ,tblProfessores.nome , tblDT.id_dt ,tblDT.nome
FROM tblPrh
...
END
GO
PRINT N'Creating [dbo].[sp_GetPrhsByDT]...';
...
END
GO
PRINT N'Creating [dbo].[sp_GetPrhsByProfessor]...';
