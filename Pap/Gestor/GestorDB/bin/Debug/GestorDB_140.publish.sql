...
GO
ALTER TABLE [dbo].[tblPrhPrincipal] ALTER COLUMN [tempo_letivos_faltas] INT NOT NULL;
...
GO
PRINT N'Refreshing [dbo].[sp_GetPrhPrincipalByPrh]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[sp_GetPrhPrincipalByPrh]';


GO
PRINT N'Refreshing [dbo].[sp_InsertPrhPrincipal]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[sp_InsertPrhPrincipal]';
