...
AS
begin
		Select tblProfessores.id_user,tblProfessores.nome,tblProfessores.data_nascimento,tblProfessores.dt,tblProfessores.id_professor from tblProfessores , tblProfessorTurmaDisciplina where tblProfessorTurmaDisciplina.id_turma=@id_turma
END
GO
