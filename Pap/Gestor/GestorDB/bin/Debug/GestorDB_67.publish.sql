...
GO
PRINT N'Altering [dbo].[sp_InsertCurso]...';


GO
ALTER PROCEDURE [dbo].[sp_InsertCurso]
	@nome varchar(100),
...
END
GO
PRINT N'Creating [dbo].[sp_GetProfessores]...';


GO
CREATE PROCEDURE [dbo].[sp_GetProfessores]
AS
BEGIN
	SELECT * FROM tblProfessores
END
GO
PRINT N'Creating [dbo].[sp_InsertTurma]...';
...
Begin
	...
	Begin
		Insert INTO [dbo].[tblTurmas]
				...
				[nome_turma],
				[diretor_turma])
		Values (@id_curso,@ano_escolaridade,@nome_turma,@diretor_turma)
		select 1 as ReturnCode
	END
END
GO
