...
GO
PRINT N'Creating [dbo].[sp_GetTurmaWhereCurso]...';


GO
CREATE PROCEDURE [dbo].[sp_GetTurmaWhereCurso]
	@id_turma int,
	@id_curso int,
	@id_curso1 int
...
AS
begin
		select * From tblTurmas,tblCursos where tblTurmas.id_curso=@id_curso1 and tblCursos.id_curso=@id_curso and @id_curso1=@id_curso
END
GO
