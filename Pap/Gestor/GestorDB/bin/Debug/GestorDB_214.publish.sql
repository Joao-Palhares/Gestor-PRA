...
GO
PRINT N'Creating [dbo].[sp_GetProfessorByDisciplinaTurma]...';
...
begin
		...
		INNER JOIN tblProfessorTurmaDisciplina ON tblProfessorTurmaDisciplina.id_professor=tblProfessores.id_professor
		INNER JOIN tblProfessorTurmaDisciplina ON tblProfessores.id_professor=tblProfessorTurmaDisciplina.id_professor
