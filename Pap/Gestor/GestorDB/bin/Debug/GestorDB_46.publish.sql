...
GO
PRINT N'Altering [dbo].[sp_GetModuloIDDisciplina]...';


GO
ALTER PROCEDURE [dbo].[sp_GetModuloIDDisciplina]
	@id_disciplina int
...
END
GO
PRINT N'Creating [dbo].[sp_GetDisciplinaByID]...';
...
END
GO
PRINT N'Creating [dbo].[sp_GetModuloByID]...';
